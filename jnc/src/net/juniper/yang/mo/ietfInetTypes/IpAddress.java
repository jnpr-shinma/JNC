 ...
 * the namespace 
 * generated to "/Users/juntao/workspace/js-easy-rest/examples/pet-store/server/target/scala-2.11/src_managed/main/net/juniper/yang/mo/ietfInetTypes/ip-address"
 * <p>
 * See line 179 in
...
public class IpAddress extends YangUnion {
    ...
    public IpAddress(String value) throws YangException {
        super(value,
            new String[] {
                "net.juniper.yang.mo.ietfInetTypes.Ipv4Address",
                "net.juniper.yang.mo.ietfInetTypes.Ipv6Address",
            }
        );
        check();
    }
