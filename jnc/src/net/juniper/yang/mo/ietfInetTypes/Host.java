 ...
 * the namespace 
 * generated to "/Users/juntao/workspace/js-easy-rest/examples/pet-store/server/target/scala-2.11/src_managed/main/net/juniper/yang/mo/ietfInetTypes/host"
 * <p>
 * See line 408 in
...
public class Host extends YangUnion {
    ...
    public Host(String value) throws YangException {
        super(value,
            new String[] {
                "net.juniper.yang.mo.ietfInetTypes.IpAddress",
                "net.juniper.yang.mo.ietfInetTypes.DomainName",
            }
        );
        check();
    }
